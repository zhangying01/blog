...
————摘自github:https://github.com/unknwon/the-way-to-go_ZH_CN
# 1.1 起源与发展
...
![Go 语言设计者：Griesemer、Thompson 和 Pike](https://gopher-cn.icu/images/1.1.designers_of_Go.jpg)
...
![]((https://gopher-cn.icu/images/1.2.Go_logo.jpg?raw=true)
